...
console.log(data);
  ...
  useEffect(()=>{
      axios.get(`${process.env.REACT_APP_backendaddress}/book/detail/`+bookid)
        .then(res=>{
        ...
        axios.get(`${process.env.REACT_APP_backendaddress}/review/byitemid/`+bookid)
          .then(res=>{
            setRatings(res.data);
          })
  ...
  const handleOnclick=()=>{
    ...
    setAdd(true);
    if(!add){
      axios.post(`${process.env.REACT_APP_backendaddress}/lib/newlib`,data)
        .then(res=>{
